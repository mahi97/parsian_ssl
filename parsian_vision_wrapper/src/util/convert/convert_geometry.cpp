...
namespace pr {
    ...
    parsian_msgs::ssl_vision_geometry convert_geometry_data(SSL_GeometryData protoData) {
        parsian_msgs::ssl_vision_geometry rosData;
        ...
        for (int i = 0; i < protoData.calib_size(); ++i) {
            ...
            parsian_msgs::ssl_vision_geom_cameracalibration rosCal = convert_geometry_camera_calibration(protoCal);
    ...
    parsian_msgs::ssl_vision_geom_cameracalibration convert_geometry_camera_calibration(SSL_GeometryCameraCalibration protoCal) {
        parsian_msgs::ssl_vision_geom_cameracalibration rosCal;
    ...
    parsian_msgs::ssl_vision_geom_field convert_geometry_field_size(SSL_GeometryFieldSize protoSize) {
        parsian_msgs::ssl_vision_geom_field rosSize;
        ...
        for (int i = 0; i < protoSize.field_lines_size(); ++i) {
            ...
            parsian_msgs::ssl_vision_geom_field_line rosLine = convert_geometry_field_line_segment(protoLine);
        ...
        for (int i = 0; i < protoSize.field_arcs_size(); ++i) {
            ...
            parsian_msgs::ssl_vision_geom_field_arc rosArc = convert_geometry_field_Circular_arc(protoArc);
    ...
    parsian_msgs::ssl_vision_geom_field_line convert_geometry_field_line_segment(SSL_FieldLineSegment protoLine) {
        parsian_msgs::ssl_vision_geom_field_line rosLine;
    ...
    parsian_msgs::ssl_vision_geom_field_arc convert_geometry_field_Circular_arc(SSL_FieldCicularArc protoArc) {
        parsian_msgs::ssl_vision_geom_field_arc rosArc;
