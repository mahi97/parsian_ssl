...
Rect2D  CField::getRegion(QString name, double k)
{
    ...
    if      (name=="ourcornertop")              r=CField::Region::OurCornerTop;
    else if (name=="ourcornerbottom")           r=CField::Region::OurCornerBottom;
    else if (name=="oppcornertop")              r=CField::Region::OppCornerTop;
    else if (name=="oppcornerbottom")           r=CField::Region::OppCornerBottom;
    else if (name=="midfieldtop")               r=CField::Region::MidFieldTop;
    else if (name=="midfieldbottom")            r=CField::Region::MidFieldBottom;
    else if (name=="frontgoalopp")              r=CField::Region::FrontGoalOpp;
    else if (name=="frontgoalour")              r=CField::Region::FrontGoalOur;
    else if (name=="center")                    r=CField::Region::Center;
    else if (name=="bigcenter")                 r=CField::Region::BigCenter;
    else if (name=="ourpenalty")                r=CField::Region::OurPenalty;
    else if (name=="opppenalty")                r=CField::Region::OppPenalty;
    else if (name=="ourfield")                  r=CField::Region::OurField;
    else if (name=="oppfield")                  r=CField::Region::OppField;
    else if (name=="oppcornertopright")         r=CField::Region::OppCornerTopRight;
    else if (name=="oppcornertopleft")          r=CField::Region::OppCornerTopLeft;
    else if (name=="oppcornerbottomright")      r=CField::Region::OppCornerBottomRight;
    else if (name=="oppcornerbottomleft")       r=CField::Region::OppCornerBottomLeft;
    else if (name=="ourcornertopright")         r=CField::Region::OurCornerTopRight;
    else if (name=="ourcornertopleft")          r=CField::Region::OurCornerTopLeft;
    else if (name=="ourcornerbottomright")      r=CField::Region::OurCornerBottomRight;
    else if (name=="ourcornerbottomleft")       r=CField::Region::OurCornerBottomLeft;
    else if (name=="ourmidfieldtop")            r=CField::Region::OurMidFieldTop;
    else if (name=="ourmidfieldbottom")         r=CField::Region::OurMidFieldBottom ;
    else if (name=="oppmidfieldtop")            r=CField::Region::OppMidFieldTop;
    else if (name=="oppmidfieldbottom")         r=CField::Region::OppMidFieldBottom;
    else if (name=="oppfieldtop")               r=CField::Region::OppFieldTop;
    else if (name=="oppfieldbottom")            r=CField::Region::OppFieldBottom;
    else if (name=="ourfieldtop")               r=CField::Region::OurFieldTop;
    else if (name=="ourfieldbottom")            r=CField::Region::OurFieldBottom;
    else if (name=="ourmidfieldtopmost")        r=CField::Region::OurMidFieldTopMost;
    else if (name=="ourmidfieldbottommost")     r=CField::Region::OurMidFieldBottomMost;
    else if (name=="field1stquarter")           r=CField::Region::Field1stQuarter;
    else if (name=="field2ndquarter")           r=CField::Region::Field2ndQuarter;
    else if (name=="field3rdquarter")           r=CField::Region::Field3rdQuarter;
    else if (name=="field4thquarter")           r=CField::Region::Field4thQuarter;
    else if (name=="ourmidfieldtopwing")        r=CField::Region::OurMidFieldTopWing;
    else if (name=="ourmidfieldbottomwing")     r=CField::Region::OurMidFieldBottomWing;
    else if (name=="ourattackonethird")         r=CField::Region::OurAttackOneThird;
    else if (name=="ourdeffenseonethird")       r=CField::Region::OurDeffenseOneThird;
    else if (name=="ourmidonethird")            r=CField::Region::OurMidOneThird;
    else if (name=="oppmidfield")               r=CField::Region::OppMidField;
    else if (name=="oppcornerlinetop")          r=CField::Region::OppCornerLineTop;
    else if (name=="oppcornerlinebottom")       r=CField::Region::OppCornerLineBottom;
    else if (name=="fieldgrid1top")             r=CField::Region::FieldGrid1Top;
    else if (name=="fieldgrid1center")          r=CField::Region::FieldGrid1Center;
    else if (name=="fieldgrid1bottom")          r=CField::Region::FieldGrid1Bottom;
    else if (name=="fieldgrid2top")             r=CField::Region::FieldGrid2Top;
    else if (name=="fieldgrid2center")          r=CField::Region::FieldGrid2Center;
    else if (name=="fieldgrid2bottom")          r=CField::Region::FieldGrid2Bottom;
    else if (name=="fieldgrid3top")             r=CField::Region:: FieldGrid3Top;
    else if (name=="fieldgrid3center")          r=CField::Region:: FieldGrid3Center;
    else if (name=="fieldgrid3bottom")          r=CField::Region:: FieldGrid3Bottom;
    else if (name=="fieldgrid4top")             r=CField::Region:: FieldGrid4Top;
    else if (name=="fieldgrid4center")          r=CField::Region:: FieldGrid4Center;
    else if (name=="fieldgrid4bottom")          r=CField::Region:: FieldGrid4Bottom;
    else if (name=="fieldgrid5top")             r=CField::Region:: FieldGrid5Top;
    else if (name=="fieldgrid5center")          r=CField::Region:: FieldGrid5Center;
    else if (name=="fieldgrid5bottom")          r=CField::Region:: FieldGrid5Bottom;
    else if (name=="oppcornerpointtop")         r=CField::Region:: OppCornerPointTop;
    else if (name=="oppcornerpointbottom")      r=CField::Region:: OppCornerPointBottom;
    else if (name=="theirpenaltytop")           r=CField::Region:: TheirPenaltyTop;
    else if (name=="theirpenaltybottom")        r=CField::Region:: TheirPenaltyBottom;
    else if (name=="attreccornertopb")          r=CField::Region::AttackRecCornerTopB;
    else if (name=="attreccornertopp1")         r=CField::Region::AttackRecCornerTopP1;
    else if (name=="attreccornertopp2")         r=CField::Region::AttackRecCornerTopP2;
    else if (name=="attreccornerbottomb")       r=CField::Region::AttackRecCornerBottomB;
    else if (name=="attreccornerbottomp1")      r=CField::Region::AttackRecCornerBottomP1;
    else if (name=="attreccornerbottomp2")      r=CField::Region::AttackRecCornerBottomp2;
    else if (name=="attrecmidtopb")             r=CField::Region::AttackRecMidTopB;
    else if (name=="attrecmidtopp1")            r=CField::Region::AttackRecMidTopP1;
    else if (name=="attrecmidtopp2")            r=CField::Region::AttackRecMidTopP2;
    else if (name=="attrecmidbottomb")          r=CField::Region::AttackRecMidBottomB;
    else if (name=="attrecmidbottomp1")         r=CField::Region::AttackRecMidBottomP1;
    else if (name=="attrecmidbottomp2")         r=CField::Region::AttackRecMidBottomp2;
    else if (name=="tc2012top1")                r=CField::Region::TC2012Top1;
    else if (name=="tc2012top2")                r=CField::Region::TC2012Top2;
    else if (name=="tc2012top3")                r=CField::Region::TC2012Top3;
    else if (name=="tc2012top4")                r=CField::Region::TC2012Top4;
    else if (name=="tc2012bottom1")             r=CField::Region::TC2012Bottom1;
    else if (name=="tc2012bottom2")             r=CField::Region::TC2012Bottom2;
    else if (name=="tc2012bottom3")             r=CField::Region::TC2012Bottom3;
    else if (name=="tc2012bottom4")             r=CField::Region::TC2012Bottom4;
    else if (name=="tc2012rect1")               r=CField::Region::TC2012Rect1;
    else if (name=="tc2012rect2")               r=CField::Region::TC2012Rect2;
    else if (name=="tc2012rect3")               r=CField::Region::TC2012Rect3;
    else if (name=="tc2012rect4")               r=CField::Region::TC2012Rect4;
    else if (name=="ourcornerpointtop")         r=CField::Region::OurCornerPointTop;
    else if (name=="ourcornerpointbottom")      r=CField::Region::OurCornerPointBottom;
    else if (name=="largeoppcornertopright")    r=CField::Region::LargeOppCornerTopRight;
    else if (name=="largeoppcornertopleft")     r=CField::Region::LargeOppCornerTopLeft;
    else if (name=="largeoppcornerbottomright") r=CField::Region::LargeOppCornerBottomRight;
    else if (name=="largeoppcornerbottomleft")  r=CField::Region::LargeOppCornerBottomLeft;
