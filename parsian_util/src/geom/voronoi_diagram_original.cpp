...
#include "parsian_util/geom/voronoi_diagram_original.h"
 ...
 */
VoronoiDiagramOriginal::VoronoiDiagramOriginal()
 ...
 */
VoronoiDiagramOriginal::VoronoiDiagramOriginal( const std::vector< Vector2D > & v )
    : M_bounding_rect( static_cast< Rect2D * >( 0 ) ),
      M_vertices(),
      M_segments(),
      M_rays()
 ...
 */
void
VoronoiDiagramOriginal::setBoundingRect( const Rect2D & rect )
{
    clearBoundingRect();
 ...
 */
void
VoronoiDiagramOriginal::clearBoundingRect()
{
    if ( M_bounding_rect )
    {
 ...
 */
void
VoronoiDiagramOriginal::clearResults()
{
    M_vertices.clear();
    M_segments.clear();
    M_rays.clear();
 ...
 */
void
VoronoiDiagramOriginal::compute()
{
 ...
 */
void
VoronoiDiagramOriginal::getPointsOnSegments( const double min_length,
