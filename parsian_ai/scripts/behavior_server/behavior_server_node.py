...
class BehaviorServer:
    def __init__(self):
        ...
        self.eval_sub = rospy.Subscriber('/eval', parsian_robot, self.getEvals, queue_size=1, buff_size=2 ** 24)
        self.selected_pub = rospy.Publisher('/behavior', parsian_robot, queue_size=1, latch=True)
