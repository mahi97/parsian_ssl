...
public:
    ...
    bool kkGetBestPlan(int planBallPos, int agentSize = 1);
...
private:
    ...
    //////////////Symmetry
    int getSymmetry(int _ballRegion);
    /////////////////////////////


    //////////////////////MAHI

    void dynamicAttack(int agentSize);
//    SDynamicPlan isDynamic(int agentSize);
    void mahiDebugs();
    ...
    /////////////////////AHZ
    QList<PSkills> failedTasks;
    QList<PSkills> doneTasks;
